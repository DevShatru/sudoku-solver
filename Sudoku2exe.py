...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Interactive Sudoku Solver.py"
 
        #Name of program
        self.project_name = "Interactive Sudoku Solver"
        ...
        #Auhor of program
        self.author_name = "Shatrujit Aditya Kumar"
        self.author_email = "shatrujit95@hotmail.com"
        self.copyright = ""
 
        #Description
        self.project_description = "Interactive Sudoku Solver"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['Puzzles.txt', "FreeSans.ttf"]
